...
//    RabbitTemplate rt;
    ...
    {
        logger.info(request.getRequestURI() + "/dogs accessed");
...
//        rt.convertAndSend(DogsinitialApplication.QUEUE_NAME_HIGH, message);
    ...
    {
        logger.info(request.getRequestURI() + "/dogs " + id + " accessed");
...
//        rt.convertAndSend(DogsinitialApplication.QUEUE_NAME_LOW, message);
    ...
    {
        logger.info(request.getRequestURI() + "/dogs/breeds " + breed + " accessed");
